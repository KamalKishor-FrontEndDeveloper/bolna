...
export default function TeamMembers() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      toast({ title: "User invited", description: "New team member has been added" });
            ...
            <DialogContent>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                ...
                <Button type="submit" className="w-full" disabled={createMutation.isPending}>
                  {createMutation.isPending ? <><Loader2 className="w-4 h-4 animate-spin mr-2" /> Inviting...</> : "Invite User"}
                </Button>
              </form>
            </DialogContent>
          </Dialog>
